...
int main()
{
    ...
    cout << setw(15) << "No. of Iteration" << setw(15) << "(x0)" << setw(15)
        << "f(x0)" << setw(15) << "(x1)" << setw(15) << "f(x1)" << setw(15) 
        << "result" << setw(15) << "f(result)" << setw(15) << "error:" << endl;
    ...
    
    {
        ...
        cout << setw(15) << i << setw(15) << x0 << setw(15) << fx0 << setw(15) 
        << x1 << setw(15) << fx1 << setw(15) << result << setw(15) << fresult 
        << setw(15) << error << endl;
